                    ...
                    <form class="form-horizontal col-md-8 col-lg-offset-1">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control" rows="4" id="sms-content-id" placeholder="Type: changewallpaper"></textarea>
                                </div>
                            </div>
